...
export const Sidebar = () => {
  return (
    <Box>
        <VStack spacing={10} alignItems={{base:"center",md:"flex-start"}} width={"16vw"} borderRight={"1px solid gray"} h={"100vh"} position={"fixed"} padding={10}>
            <Box marginBottom={10} overflow={"hidden"}><Image h={{base:"0", xl:"40px"}} src={"/logo1.png"}/></Box>
            <Flex width={"6.5vw"} borderRadius={6} _hover={{bg:"whiteAlpha.400"}} alignItems={"center"}><Image h={"4vh"} src={"/home2.png"} marginRight={3}/><Link to={"/"} cursor={"pointer"}><Span display={{base:"none", lg:"block"}} fontSize={18}>Home</Span></Link></Flex>
            <Flex width={"6.5vw"} borderRadius={6} _hover={{bg:"whiteAlpha.400"}} alignItems={"center"}><Image h={"4vh"} src={"/search.png"} marginRight={3}/><Link to={"/auth"} cursor={"pointer"}><Span display={{base:"none", lg:"block"}} fontSize={18}>Search</Span></Link></Flex>
